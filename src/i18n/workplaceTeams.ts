    ...
    sections: [
      {
        ...
        points: [
          { title: 'Services and catering', body: 'Keep service requirements, catering choices, participant counts and dietary needs connected to the conference.' },
          { title: 'Review before processing', body: 'Make cost allocation and the final request review explicit before operational work moves forward.' },
        ],
      },
      {
      ...
      },
      {
        ...
        points: [
          { title: 'Keep the original context understandable', body: 'Treat a change as a deliberate lifecycle event instead of an invisible edit to a confirmed request.' },
          { title: 'Keep decisions explicit', body: 'Pending changes remain visible for the responsible Conference Manager decision before they become part of the confirmed context.' },
        ],
      },
      {
        eyebrow: 'Existing-system fit',
        title: 'Improve the conference operation without creating a room-booking replacement project.',
    ...
    sections: [
      {
        ...
        points: [
          { title: 'Services und Catering', body: 'Halten Sie Service-Anforderungen, Catering-Auswahl, Teilnehmerzahlen und Ernährungsanforderungen direkt an der Konferenz.' },
          { title: 'Prüfung vor der Bearbeitung', body: 'Machen Sie Kostenverteilung und abschließende Prüfung sichtbar, bevor die operative Bearbeitung weitergeht.' },
        ],
      },
      {
      ...
      },
      {
        ...
        points: [
          { title: 'Ursprünglichen Kontext erhalten', body: 'Behandeln Sie eine Änderung als bewussten Lebenszyklus-Schritt und nicht als unsichtbare Bearbeitung einer bestätigten Anfrage.' },
          { title: 'Entscheidungen explizit halten', body: 'Offene Änderungen bleiben für die verantwortliche Entscheidung sichtbar, bevor sie Teil des bestätigten Kontexts werden.' },
        ],
      },
      {
        eyebrow: 'Bestehende Systeme nutzen',
        title: 'Verbessern Sie den Konferenzbetrieb, ohne ein Austauschprojekt für die Raumbuchung zu starten.',
