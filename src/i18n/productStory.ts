...
const stories: Record<Locale, Record<ProductStorySlug, ProductStoryCopy>> = {
  en: {
      ...
      sections: [
        {
          ...
          points: [
            { title: 'Room context', body: 'Keep the room decision connected while the existing booking system remains responsible for the reservation.' },
            { title: 'Services', body: 'Capture relevant workplace-service requirements without starting a separate coordination trail.' },
            { title: 'Catering', body: 'Keep catering needs, participant counts and dietary requirements with the conference.' },
            { title: 'Review', body: 'Make cost allocation and final review visible before the request moves forward.' },
          ],
        },
        {
        ...
        },
        {
          ...
          points: [
            { title: 'Employee experience', body: 'Ask for the conference through a clear journey rather than navigating internal ownership.' },
            { title: 'Operational visibility', body: 'Work with the booking and management context needed to prepare and oversee the conference.' },
          ],
        },
        {
    ...
    'how-it-works': {
      sections: [
        { eyebrow: '01 · Request', title: 'Start with the conference itself.', body: 'The employee begins with date, time and room context, then moves through the decisions needed for the conference instead of navigating separate internal processes.' },
        { eyebrow: '02 · Requirements', title: 'Keep services and catering in the same journey.', body: 'Service requirements, catering, participant context and dietary needs stay attached to the conference so preparation is not split across unrelated channels.' },
        { eyebrow: '03 · Review', title: 'Review the request before it enters processing.', body: 'Cost allocation and a dedicated review step keep important decisions visible before the conference request moves forward.' },
        { eyebrow: '04 · Connect', title: 'Keep room booking connected, not duplicated.', body: 'The existing room-booking capability remains responsible for the reservation. Conference Manager adds the conference context around it rather than rebuilding specialist booking infrastructure.', statement: "We don't replace your room booking system. We connect it." },
        { eyebrow: '05 · Operate and change', title: 'Manage the conference beyond submission.', body: 'Workplace views support bookings, room planning, reporting and administration, while the request lifecycle keeps supported changes, rejection and cancellation explicit.' },
      ],
      closing: {
  ...
  de: {
      ...
      sections: [
        {
          ...
          points: [
            { title: 'Raumkontext', body: 'Binden Sie die Raumentscheidung ein, während das vorhandene Buchungssystem für die Reservierung verantwortlich bleibt.' },
            { title: 'Services', body: 'Erfassen Sie relevante Workplace-Services, ohne einen separaten Abstimmungsweg zu starten.' },
            { title: 'Catering', body: 'Halten Sie Catering-Bedarf, Teilnehmerzahlen und Ernährungsanforderungen bei der Konferenz.' },
            { title: 'Prüfung', body: 'Machen Sie Kostenverteilung und abschließende Prüfung sichtbar, bevor die Anfrage weitergeht.' },
          ],
        },
        {
        ...
        },
        {
          ...
          points: [
            { title: 'Employee Experience', body: 'Die Konferenz über einen klaren Ablauf anfragen, statt interne Zuständigkeiten navigieren zu müssen.' },
            { title: 'Operative Transparenz', body: 'Mit dem Buchungs- und Managementkontext arbeiten, der für Vorbereitung und Steuerung benötigt wird.' },
          ],
        },
        {
    ...
    'how-it-works': {
      sections: [
        { eyebrow: '01 · Anfrage', title: 'Beginnen Sie bei der Konferenz selbst.', body: 'Mitarbeitende starten mit Datum, Zeit und Raumkontext und gehen anschließend durch die für die Konferenz relevanten Entscheidungen – nicht durch getrennte interne Prozesse.' },
        { eyebrow: '02 · Anforderungen', title: 'Halten Sie Services und Catering im selben Ablauf.', body: 'Service-Anforderungen, Catering, Teilnehmerkontext und Ernährungsanforderungen bleiben an der Konferenz, damit die Vorbereitung nicht auf voneinander getrennte Kanäle verteilt wird.' },
        { eyebrow: '03 · Prüfung', title: 'Prüfen Sie die Anfrage, bevor sie in die Bearbeitung geht.', body: 'Kostenverteilung und ein eigener Prüfschritt halten wichtige Entscheidungen sichtbar, bevor die Konferenzanfrage weiterläuft.' },
        { eyebrow: '04 · Verbinden', title: 'Binden Sie die Raumbuchung ein, statt sie zu duplizieren.', body: 'Die bestehende Raumbuchung bleibt für die Reservierung verantwortlich. Conference Manager ergänzt den Konferenzkontext darum herum, statt spezialisierte Buchungsinfrastruktur nachzubauen.', statement: 'Wir ersetzen Ihre Raumbuchung nicht. Wir verbinden sie.' },
        { eyebrow: '05 · Steuern und ändern', title: 'Begleiten Sie die Konferenz über das Absenden hinaus.', body: 'Workplace-Sichten unterstützen Buchungen, Raumplanung, Reporting und Administration. Gleichzeitig hält der Anfrage-Lebenszyklus unterstützte Änderungen, Ablehnung und Stornierung nachvollziehbar.' },
      ],
      closing: {
