    ...
    sections: [
      {
        ...
        points: [
          {
            title: 'Application sessions stay with the product',
            body: 'The public website does not own Conference Manager access tokens, refresh tokens or authenticated session state.',
          },
          {
            title: 'Login is a handoff, not a second sign-in flow',
            body: 'Existing users move to the application-owned authentication flow through an ordinary HTTPS link.',
          },
        ],
      },
      {
        ...
        statement:
          'The marketing experience stays public. Trusted product authority stays with the application and API.',
      },
      {
        ...
        points: [
          {
            title: 'No privileged secrets in the website',
            body: 'Provider credentials and privileged configuration remain server-side and are not shipped in the public browser bundle.',
          },
          {
            title: 'Operational acceptance still matters',
            body: 'Automated repository tests support confidence but do not replace real endpoint, mailbox, privacy, logging and anti-abuse evidence.',
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        points: [
          {
            title: 'Anwendungssessions bleiben im Produkt',
            body: 'Die öffentliche Website besitzt keine Conference-Manager-Access-Tokens, Refresh-Tokens oder authentifizierten Anwendungssessions.',
          },
          {
            title: 'Login ist eine Übergabe, kein zweiter Anmeldeprozess',
            body: 'Bestehende Nutzer wechseln über einen normalen HTTPS-Link in den von der Anwendung verantworteten Authentifizierungsprozess.',
          },
        ],
      },
      {
        ...
        statement:
          'Die Marketing-Erfahrung bleibt öffentlich. Vertrauenswürdige Produkt-Autorität bleibt bei Anwendung und API.',
      },
      {
        ...
        points: [
          {
            title: 'Keine privilegierten Secrets in der Website',
            body: 'Provider-Zugangsdaten und privilegierte Konfiguration bleiben serverseitig und werden nicht im öffentlichen Browser-Bundle ausgeliefert.',
          },
          {
            title: 'Operative Abnahme bleibt erforderlich',
            body: 'Automatisierte Repository-Tests unterstützen die Qualität, ersetzen aber keine reale Endpoint-, Mailbox-, Datenschutz-, Logging- und Anti-Abuse-Evidenz.',
          },
        ],
      },
      {
